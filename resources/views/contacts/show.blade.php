...
@section('title', 'Contact App | Show Contact '. $contact->first_name)
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group row">
                        <label for="first_name" class="col-md-3 col-form-label">Frist Name</label>
                        <div class="col-md-9">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <p class="form-control-plaintext text-muted"> {{ $contact->company_id}}
                          </p>
                        </div>
                      </div>
                      <hr>
